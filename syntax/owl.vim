...
syntax keyword owlKeywords if def fun then else elif end do in case cond of set while and or for when let var iter module struct trait use
syntax keyword owlSpecial #t #f = ~= echo arg yield, export
